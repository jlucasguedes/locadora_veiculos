...
public class Teste extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ClienteDAO cs = DAOFactory.getClienteDAO(con);
            Cliente cliente = cs.buscar(request.getParameter("cpf"));
            ...
            if (cliente == null) {
                out.println("<p> funcionario is null </p>");
            } else {
                out.println("<p>" + cliente.getNome() + "</p>");
            }
