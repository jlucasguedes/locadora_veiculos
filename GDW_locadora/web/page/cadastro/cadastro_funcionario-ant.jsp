<%-- 
    ...
    Created on : 05/10/2014, 18:26:37
    Author     : Lucas
--%>
            ...
            <div id="content">
                <form class="form_edit" method="GET" action="Controller">                    
                    ...
                    <table cellpadding="10px">
                        <thead>
                            <tr>
                                <th colspan="2">Cadastrar novo Funcionário</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <td><label for="">Data de Admissão:</label></td>
                                <td><input type="text" name="data_admissao" placeholder="Data de Admissão"/></td>
                            </tr>
                            <tr>
                                <td><label for="">Salário:</label></td>
                                <td><input type="text" name="salario" placeholder="Salário"/></td>
                            </tr>
                            <tr>
