...
<jsp:useBean id="cliente" scope="request" class="gdw.locadora.model.Cliente" />
        ...
        <div class="container">
            <div class="row" id="content-main">
                <div class="col-md-12">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" style="width: 40px">
                                                <li>                                                   
                                                    <a href="#" data-toggle="modal" data-target="#modalClienteID${cliente.id}" ><i class="glyphicon glyphicon-user"></i> Perfil Completo</a>
                                                </li>
                                                <li>
                                                </li>
                                            </ul>
                    ...
                    <c:forEach items="${clientes}" var="cliente">
                        <!-- Modal -->
                        <div class="modal fade" id="modalClienteID${cliente.id}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Fechar</span></button>
                                        <h4 class="modal-title" id="myModalLabel">${cliente.nome}</h4>
                                    </div>
                                        ...
                                        <table class="table table-condensed" id="perfil-completo">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><fmt:formatDate pattern="dd/MM/yyyy" value="${cliente.dataDeNascimento}"/></td>
                                                </tr>
                                                <tr>
                                                    <td>CPF: </td>
                                                    <td>${cliente.cpf}</td>
